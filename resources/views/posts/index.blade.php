    ...
    <div class="container">
      ...
      <div class="row header"><!-- Begin Header -->
        ...
        <div class="span7 navigation">
           ...
           @else
           <li> <a href="{{ route('login.create') }}" >Log in</a> <a href="{{ route('register.create') }}">Register</a>
                </li>
       @endauth
    ...
    <div class="row"><!-- Begin Bottom Section -->
        ...
        <div id="blogCarousel" class="carousel slide ">
            ...
            <div class="carousel-inner">
                ...
                <div class="active item">
                    <a href="blog-single.htm"><img src="assets/front/img/gallery/blog-med-img-1.jpg" alt="" class="align-left blog-thumb-preview" /></a>
        ...
        <div class="span6">
            ...
            <ul class="client-logos">
                <li><a href="#" class="client-link"><img src="assets/front/img/gallery/client-img-1.png" alt="Client"></a></li>
                <li><a href="#" class="client-link"><img src="assets/front/img/gallery/client-img-2.png" alt="Client"></a></li>
                <li><a href="#" class="client-link"><img src="assets/front/img/gallery/client-img-3.png" alt="Client"></a></li>
                <li><a href="#" class="client-link"><img src="assets/front/img/gallery/client-img-4.png" alt="Client"></a></li>
                <li><a href="#" class="client-link"><img src="assets/front/img/gallery/client-img-5.png" alt="Client"></a></li>
            </ul>
